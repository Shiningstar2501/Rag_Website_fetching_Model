...
def retrieve_relevant_chunks(vectorstore, question, k=15):
...
# MAIN FLOW
file_path = "Extracted_Embassy_Links (3) (2) (1).xlsx"  # Replace with actual uploaded file
